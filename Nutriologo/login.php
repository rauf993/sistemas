<?php $url = "http://" . $_SERVER['HTTP_HOST'] . "/curd2/" ?>
...
<body>
    <form action="validatePacientes.php" method="POST">
        <div class="imgcontainer">
            <img src="images/nutricion.png" alt="User" class="user" width="300" height="200">
        </div>
