...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="container">
        <br/>
        <h2>Registrar Dietas</h2>
        <hr/>
        <form action="registerDieta.php" method="POST">
          <div class="container">
            <?php
...
<input type="text" placeholder="alimentos" name="alimentos" required>
<input type="text" placeholder="ejercicios" name="ejercicios" required>
