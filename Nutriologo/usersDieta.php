<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query = "SELECT * FROM crearDieta WHERE idPaciente LIKE '%".$valueToSearch."%' OR idNutriologo LIKE '%".$valueToSearch."%'";
		$result = filterRecord($query);
	}
	else
	{
		$query = "SELECT * FROM crearDieta";
		$result = filterRecord($query);
	}
...
<body>
    ...
    while($row = mysqli_fetch_array($result))
    {
      ...
      echo "<td>" . $row['alimentos'] . "</td>";
      echo "<td>" . $row['ejercicios'] . "</td>";
      echo "<td><a href='editDieta.php?idPaciente=".$row['idPaciente']."'><img src='./images/icons8-Edit-32.png' alt='Edit'></a></td>";
      echo "<td><a href='delateDieta.php?idPaciente=".$row['idPaciente']."'><img src='./images/icons8-Trash-32.png' alt='Delete'></a></td>";
